...
const CATEGORIES: CategoryConfig[] = [
  ...
  },
  {
    ...
    label: "En Popüler",
    count: 4,
    slugs: ["hurrem-masaji", "sultan-masaji", "mix-masaj", "aroma-terapi-masaji"],
  },
  {
    id: "relax",
    label: "Derin Dinlenme",
    count: 4,
    slugs: ["soft-masaj", "aroma-terapi-masaji", "tai-masaji", "klasik-masaj"],
  },
  {
    id: "vip",
    label: "VIP & Özel",
    count: 3,
    slugs: ["hurrem-masaji", "sultan-masaji", "badi-masaj"],
  },
];

const SERVICE_META: Record<string, { badge: string; badgeColor: string }> = {
  "hurrem-masaji": {
    badge: "👑 HÜRREM İMZA SEANS",
    badgeColor: "bg-gradient-to-r from-amber-500 to-amber-600 text-white shadow-amber-500/30",
  },
  "sultan-masaji": {
    badge: "⭐ ÇOK SATAN VIP",
    badgeColor: "bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-purple-500/30",
  },
  "mix-masaj": {
    badge: "🔥 KİŞİYE ÖZEL HİT",
    badgeColor: "bg-gradient-to-r from-rose-500 to-red-600 text-white shadow-rose-500/30",
  },
  "aroma-terapi-masaji": {
    badge: "🌿 BİTKİSEL ESANSİYEL",
    badgeColor: "bg-gradient-to-r from-emerald-600 to-teal-600 text-white shadow-emerald-500/30",
  },
  "soft-masaj": {
    badge: "☁️ DERİN DİNLENME",
    badgeColor: "bg-gradient-to-r from-sky-500 to-blue-600 text-white shadow-sky-500/30",
  },
  "klasik-masaj": {
    badge: "💆 GELENEKSEL SEANS",
    badgeColor: "bg-gradient-to-r from-indigo-500 to-blue-600 text-white shadow-indigo-500/30",
  },
  "tai-masaji": {
    badge: "🧘 CANLANDIRICI ESNEME",
    badgeColor: "bg-gradient-to-r from-teal-500 to-emerald-600 text-white shadow-teal-500/30",
  },
  "badi-masaj": {
    badge: "💪 DERİN DOKU",
    badgeColor: "bg-gradient-to-r from-orange-500 to-amber-600 text-white shadow-orange-500/30",
  },
};
...
export default function HomeServicesSection() {
  ...
  const filteredServices: Service[] = currentCategory.slugs
  ...
  return (
    <section id="hizmetler" className="py-12 md:py-20 bg-white">
      <div className="container-custom">
        ...
        {/* Category Pills (Mobile Friendly Horizontal Scroll with Counts) */}
        <div className="flex items-center gap-2.5 overflow-x-auto pb-4 mb-6 no-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0">
          {CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className={`px-4 sm:px-5 py-2.5 rounded-full text-xs sm:text-sm font-bold tracking-wide transition-all whitespace-nowrap cursor-pointer flex items-center gap-2 ${
                  isActive
              ...
              return (
                ...
                >
                  ...
                  <div className="relative w-full aspect-[16/10] sm:h-48 overflow-hidden bg-gray-900">
                    ...
                    {/* Top Row: Duration Badge & Category Highlight Badge */}
                    <div className="absolute top-2.5 left-2.5 right-2.5 flex items-center justify-between gap-1 pointer-events-none">
                      <span className="bg-black/65 backdrop-blur-md text-white text-[11px] font-bold px-2.5 py-1 rounded-full border border-white/20 shadow-sm">
                        ⏱ {service.duration}
                      </span>
                      <span
                        className={`text-[10px] font-extrabold px-2.5 py-1 rounded-full shadow-md tracking-wider uppercase ${meta.badgeColor}`}
                      >
                        {meta.badge}
                      </span>
                    </div>

                    {/* Bottom of Image: Short Name */}
