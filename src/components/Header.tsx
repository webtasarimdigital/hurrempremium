...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled
            ...
            : "bg-gradient-to-b from-black/70 via-black/30 to-transparent py-3.5 sm:py-4"
        }`}
      >
        <div className="container-custom flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-2 bg-primary hover:bg-primary-dark text-white text-sm font-bold px-5 py-2.5 rounded-xl shadow-md shadow-primary/20 hover:scale-[1.02] transition-all duration-200"
            >
          ...
          >
            <span
              className={`block w-6 h-0.5 bg-current transition-all duration-300 ${
                mobileMenuOpen ? "rotate-45 translate-y-2 !text-white" : ""
              }`}
            />
            <span
              className={`block w-6 h-0.5 bg-current transition-all duration-300 ${
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 z-40 bg-[#0c0c0e]/98 backdrop-blur-xl transition-opacity duration-300 md:hidden ${
