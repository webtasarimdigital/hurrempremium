...
export default function HomePage() {
  return (
    <>
      {/* ── 1. MODERN HERO SECTION (Optimized for Mobile Conversion) ── */}
      <section className="relative min-h-[75vh] md:min-h-[580px] lg:min-h-[620px] flex items-center justify-center bg-[#1b0d12] overflow-hidden pt-24 pb-16">
        {/* Background Image */}
        <div
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#1b0d12] via-[#1b0d12]/75 to-[#1b0d12]/85" />
        ...
        <div className="relative z-10 container-custom text-center max-w-3xl mx-auto px-4">
          ...
          <h1 className="text-white text-3xl sm:text-5xl lg:text-6xl font-black leading-tight tracking-tight drop-shadow-md mb-4 sm:mb-6">
            Denizli&apos;de Eşsiz <br />
          ...
          <p className="text-white/80 text-sm sm:text-base lg:text-lg font-normal leading-relaxed max-w-xl mx-auto mb-8 sm:mb-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center max-w-md mx-auto">
            <WhatsAppCTA location="hero" variant="primary" className="h-14 px-8 text-base w-full sm:w-auto shadow-xl shadow-primary/30">
            ...
            <PhoneCTA location="hero" variant="outline-light" className="h-14 px-6 text-sm w-full sm:w-auto">
          ...
          <div className="mt-8 pt-6 border-t border-white/10 flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-xs font-semibold text-white/70">
            <span className="flex items-center gap-1.5">
              <span className="text-primary font-bold">✓</span> 12:00 – 00:00 Her Gün
            </span>
            <span className="flex items-center gap-1.5">
              <span className="text-primary font-bold">✓</span> 8+ Masaj Türü
            </span>
            <span className="flex items-center gap-1.5">
              <span className="text-primary font-bold">✓</span> Hijyenik & VIP Seanslar
            </span>
          </div>
        </div>
      </section>
