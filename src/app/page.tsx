  ...
  return (
    <>
      ...
      <section className="relative min-h-[calc(100dvh-64px)] md:min-h-[620px] flex flex-col justify-between bg-[#1b0d12] overflow-hidden pt-20 pb-5 md:py-24">
        ...
        {/* Hero Center Content */}
        <div className="relative z-10 container-custom text-center max-w-3xl mx-auto px-4 my-auto">
          {/* Eyebrow badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-black/50 backdrop-blur-md border border-white/20 mb-3.5 sm:mb-5 shadow-lg">
          ...
          <h1 className="text-white text-3xl sm:text-5xl lg:text-6xl font-black leading-[1.18] tracking-tight drop-shadow-md mb-3 sm:mb-5">
            Denizli&apos;de Eşsiz <br />
          ...
          <p className="text-white/90 text-xs sm:text-base lg:text-lg font-normal leading-relaxed max-w-lg mx-auto mb-6 sm:mb-8 drop-shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center max-w-md mx-auto">
            <WhatsAppCTA location="hero" variant="primary" className="h-13 sm:h-14 px-8 text-sm sm:text-base w-full sm:w-auto shadow-xl shadow-primary/40 bg-gradient-to-r from-[#d9265b] to-[#bd0f49] hover:from-[#bd0f49] hover:to-[#941238]">
            ...
            <PhoneCTA location="hero" variant="outline-light" className="h-13 sm:h-14 px-6 text-sm w-full sm:w-auto bg-black/40 hover:bg-white/15 border-white/25 backdrop-blur-md">
        ...
        <div className="relative z-10 container-custom text-center px-4 pt-4">
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 text-xs font-semibold text-white/90 mb-2">
            <span className="px-3 py-1.5 rounded-full bg-black/50 backdrop-blur-md border border-white/15 flex items-center gap-1.5 shadow-sm">
          ...
          <a
            href="#hizmetler"
            className="inline-flex items-center gap-1.5 text-[11px] sm:text-xs text-pink-200/80 hover:text-white transition-colors animate-bounce mt-1"
          >
