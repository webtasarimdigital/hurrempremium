      ...
      <section className="relative min-h-[calc(100dvh-64px)] md:min-h-[620px] flex flex-col justify-between bg-[#0c0c0e] overflow-hidden pt-20 pb-5 md:py-24">
        ...
        <div className="relative z-10 container-custom text-center max-w-3xl mx-auto px-4 my-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center w-full max-w-xl mx-auto">
            <WhatsAppCTA location="hero" variant="primary" className="h-13 sm:h-14 px-7 sm:px-8 text-sm sm:text-base w-full sm:w-auto shadow-xl shadow-primary/40 bg-gradient-to-r from-[#d9265b] to-[#bd0f49] hover:from-[#bd0f49] hover:to-[#941238] whitespace-nowrap">
            ...
            <PhoneCTA location="hero" variant="outline-light" className="h-13 sm:h-14 px-6 text-sm sm:text-base w-full sm:w-auto bg-black/40 hover:bg-white/15 border-white/25 backdrop-blur-md whitespace-nowrap">
        ...
        <div className="relative z-10 container-custom text-center px-4 pt-4 sm:pt-6 pb-2">
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 text-xs font-semibold text-white/90 mb-3">
            <span className="px-3.5 py-1.5 rounded-full bg-black/50 backdrop-blur-md border border-white/15 flex items-center gap-1.5 shadow-sm whitespace-nowrap">
          ...
          <a
            href="#hizmetler"
            className="inline-flex items-center gap-1.5 text-[11px] sm:text-xs text-pink-200/80 hover:text-white transition-colors animate-bounce mt-2"
          >
